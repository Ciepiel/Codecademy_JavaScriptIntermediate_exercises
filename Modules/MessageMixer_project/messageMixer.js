//object to represent the module with behavior attached
let MessageMixer = {};
//each function then needs to be a property of an object
//in order to do so- MessageMixer.functionName
